    ...
    <div className={styles.container}>
      <div className={styles.imageContainer}>
        <img
          ...
          src="https://cdn.discordapp.com/attachments/823289762022162472/823955102858870795/para_gabriel.png"
        ...
        <div className={styles.overlay}>
          <div className={styles.left}>
            ...
            <div className={styles.rod}>
              <button className={styles.lastOne} id="resultado">
                resultado
              </button>
            </div>
          </div>
